...
echo ""
echo "Fix tá ið"
$CS structure_queries/far-taid.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix tá ið"
$CS structure_queries/far-taid2.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix tí at"
$CS structure_queries/far-tiat.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix so at"
$CS structure_queries/far-soat.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix sigur"
$CS structure_queries/far-prune-np.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix til tess"
$CS structure_queries/far-pp1.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix NP idomsonly P"
$CS structure_queries/far-pp-label1.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix av stað"
$CS structure_queries/far-pp-avstad.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix CP-REL"
$CS structure_queries/far-cprel-label.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Fix IP-INF"
$CS structure_queries/far-ipinf.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Replace label ADJP to NP-SBJ"
$CS structure_queries/far-adjp-label1.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Replace label ADJP to NP-OB1"
$CS structure_queries/far-adjp-label2.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Replace label IP-INF to NP-POS"
$CS structure_queries/far-ipinf-label1.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Replace label NP-* to NP"
$CS structure_queries/far-np-label1.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Replace label NP-* to NP-POS"
$CS structure_queries/far-np-label2.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "Prune ADVP idomsonly RP"
$CS structure_queries/far-prune-rp.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE

echo ""
echo "1p VBPS|VBDS becomes VBPI"
$CS structure_queries/far-VBPI.q $FILE >> problemfile.txt
mv -f $FILE.out $FILE
