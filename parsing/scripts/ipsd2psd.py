...
#    rep("\((NPR)-([NADG]) ([Tt]ú)-(tús)\)","(PRO-N \\3-tú)")
    ...
    rep("\((['"+allchars+"']+) ([Tt]ítt)-(['"+allchars+"']+)\)","(PRO-\\1 \\2-tín)")
    ...
    rep("\((['"+allchars+"']+)-(['"+allchars+"']+) ([Ll]ati)-(['"+allchars+"']+)\)","(VBPI \\3-láta)")
    rep("\((['"+allchars+"']+) ([Ll]ati)-(['"+allchars+"']+)\)","(VBPI \\2-láta)")
    rep("\((['"+allchars+"']+)-(['"+allchars+"']+) ([Ll]ata)-(['"+allchars+"']+)\)","(VBPI \\3-láta)")
    rep("\((['"+allchars+"']+) ([Ll]ata)-(['"+allchars+"']+)\)","(VBPI \\2-láta)")
